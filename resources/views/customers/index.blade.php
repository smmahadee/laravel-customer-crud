                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="input-group mb-3">
                               <form action="{{ route('customers.index') }}" method="GET" class='order-form'>      <select class="form-select" name="order" id="" onchange="$('.order-form').submit()">
                        ...
                        <div class="col-md-2">
                            <a class="btn" href="{{ route('customers.trash') }}"><i class="fas fa-trash-alt"></i> Trash</a>
                        </div>
                    </div>
                            ...
                            @foreach ($customers as $customer)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:;" onclick="if(confirm('Are you sure you want to delete ?')) $('.form-{{ $customer->id }}').submit()" style="color: #2c2c2c;" class="ms-1 me-1"><i
